...
{
	public sealed class MirrorFlipInfo : IMirrorFlipInfo
	{
		...
		#region IMirrorFlipInfo implementation

		public bool IsMirrorMode  { get; private set; }

		public bool IsFlipMode { get; private set; }
